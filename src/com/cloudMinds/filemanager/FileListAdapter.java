    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (fileInfo != null) {
            ...
            if (mFileSettingsHelper.getBoolean(FileSettingsHelper.KEY_ONLY_SHOW_FILENAME, false)) {
                ...
                holder.fileModifiedDate.setText(Util.formatDateString(mContext,
                        fileInfo.modifiedDate));
                holder.fileSize.setText(fileInfo.isDir ? "" : Util
            ...
            holder.fileCheckBox.setVisibility(mFileOperationHelper.isOperation() ? View.VISIBLE
                    : View.GONE);
            holder.fileCheckBox
                    .setImageResource(fileInfo.selected ? R.drawable.btn_check_on_holo_light
                            : R.drawable.btn_check_off_holo_light);
            holder.fileCheckBox.setTag(fileInfo);
            holder.fileCheckBoxArea
                    .setOnClickListener(new FileOperationHelper.FileOnOperationClickListener(
                            mContext,
