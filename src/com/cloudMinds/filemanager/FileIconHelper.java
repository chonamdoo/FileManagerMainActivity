...
import com.cloudMinds.filemanager.FileIconLoader.IconLoadFinishListener;
...
public class FileIconHelper implements IconLoadFinishListener {
    ...
    public static void setSDCardInfoIcon(FileInfo fileInfo, ImageView imageView) {
        String extFromFilename = Util.getExtFromFilename(fileInfo.filePath);
